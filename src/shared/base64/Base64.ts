...
/*
JS/TS мають власні Base64 інструменти, але вони працюють
тільки для ASCII символів. При спробі кодувати кирилицю
виникають винятки.
Корекція: Юнікод-символи декодуємо у байт-послідовності,
які кодуємо як звичайні ASCII
*/